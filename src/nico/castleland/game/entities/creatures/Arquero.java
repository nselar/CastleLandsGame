...
public class Arquero extends Personaje {
	...
	//Animations
		...
		public Arquero(Handler handler, float x, float y) {
			...
			//Animaciones
			animDown = new Animación(500, Assets.arquero_down);
			animUp = new Animación(500, Assets.arquero_up);
			animLeft = new Animación(500, Assets.arquero_left);
			animRight = new Animación(500, Assets.arquero_right);
